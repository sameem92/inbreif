      ...
      <List sx={{ background: "#124651", padding: "2rem", height: "100vh" }}>
        ...
        <div className="social-menu-footer" style={{ marginTop: "20px" }}>
          <ul>
            ...
            <li>
              <a href="https://www.x.com/inbriefclick" target="_blank" rel="noopener noreferrer" title="Twitter">
            ...
            <li>
              <a href="https://snapchat.com/t/g12guzDD" target="_blank" rel="noopener noreferrer" title="Snapchat">
