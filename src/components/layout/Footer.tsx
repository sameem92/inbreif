...
const footer = "/image/fo.png";
const timer = "/image/time.png";
const email = "/image/email.png";
const location = "/image/location.png";
const phone = "/image/phone.png";
const up = "/image/up.png";
const arrow = "/image/arrow-d.png";
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                >
                  ...
                  >
                    <strong>أوقات الدوام</strong>: من الساعة 8 صباحاً إلى ٨
                    مساءً يومياً عدا الجمعة
                  </Typography>
                </Box>
              ...
              target="_blank"
                    ...
                    <li>
                      <a
              href="https://www.twitter.com/inbriefclick"
              target="_blank"
                        rel="noopener noreferrer"
                      >
                        <svg
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <a
                      href="mailto:contact@inbrief.click"
                      style={{ color: "white" }}
                    >
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        <strong>الدمام</strong> : طريق الملك فهد مع طريق عثمان
                        ابن عفان مقابل عمارة المعجل
                      </span>
                    </Typography>
                    <Typography
                      variant="body2"
                    ...
                    >
                      ...
                      <strong>
                        <a href="tel:+966552647805" style={{ color: "white" }}>
                         966552647805+
                        </a>
                      </strong>
                    </Typography>
                  ...
                  >
                    ...
                    >
                      ...
                      <strong>
                        <a href="tel:+96550337772+" style={{ color: "white" }}>
                          96550337772+
                        </a>
                      </strong>
                    </Typography>
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        <strong>مسقط</strong>: العذيبة - ١٨نوفمبر -مقابل بنك
                        مسقط
                      </span>
                    </Typography>
                    <Typography
                    ...
                    >
                      ...
                      <strong>
                        <a href="tel:+96877276659" style={{ color: "white" }}>
                         96877276659+
                        </a>
                      </strong>
                    </Typography>
